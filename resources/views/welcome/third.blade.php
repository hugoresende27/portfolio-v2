...
{{--                        <p class="text-sm sm:text-xl mt-1 text-justify  " style="color:white;">--}}
                        <p class="text-white text-center text-xl sm:text-2xl">
                            My strengths lie in PHP, Laravel, mySQL, JS, HTML, CSS, and bootstrap. I prioritize a streamlined workflow, utilize GIT for version control, and collaborate effectively with others.
                            I'm always updating my knowledge of programming languages and staying current with new technologies and approaches to problem-solving. I'm excited about the opportunity to bring my skills and experience to your team and contribute to the success of your projects.
