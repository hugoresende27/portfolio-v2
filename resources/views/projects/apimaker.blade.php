                                ...
                                <div class="space-y-12">
                                    ...
                                    <div class="border-b border-gray-900/10 pb-12">
                                        ...
                                        <div class="text-center m-3 p-3">
                                            <button type="button" class="w-10 rounded-full bg-indigo-600 p-2 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                        ...
                                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6" id="columnEntry">
